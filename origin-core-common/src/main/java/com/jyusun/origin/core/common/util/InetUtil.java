...
public final class InetUtil {
     ...
     *
     * <p>
     * Returns an <status>InetAddress</status> object encapsulating what is most likely
     * the machine's LAN IP address.
     * <p/>
     * This method is intended for use as a replacement of JDK method
     * <status>InetAddress.getLocalHost</status>, because that method is ambiguous on
     * Linux systems. Linux systems enumerate the loopback network interface the same way
     * as regular LAN network interfaces, but the JDK
     * <status>InetAddress.getLocalHost</status> method does not specify the algorithm
     * used to select the address returned under such circumstances, and will often return
     ...
     * <status>InetAddress.getLocalHost</status>.
     * <p/>
     *
