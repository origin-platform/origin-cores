 ...
 * @version 1.0.0
 */
public interface CoreRepository<T extends Model<?>> extends IService<T> {

    /**
     * 唯一校验
     *
     * @param wrapper    {@link Wrapper}条件构造器
     * @param baseKvEnum {@link BaseKvEnum} 响应信息
     * @return false 不存在
     */
    Boolean unique(Wrapper<T> wrapper, BaseKvEnum baseKvEnum);
