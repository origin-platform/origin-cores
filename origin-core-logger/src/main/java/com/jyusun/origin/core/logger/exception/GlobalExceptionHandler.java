...
public class GlobalExceptionHandler {
    ...
    public AbstractResult<Serializable> handleError(MissingServletRequestParameterException e) {
        ...
        log.warn(OutForUtil.buildWarnMessage(SystemResultEnum.BAD_REQUEST_PARAM_MISS, e.getMessage()));
    ...
    public AbstractResult<Serializable> handleError(MethodArgumentTypeMismatchException e) {
        ...
        log.warn(OutForUtil.buildWarnMessage(SystemResultEnum.BAD_REQUEST_PARAM_TYPE_ERROR, e.getMessage()));
    ...
    private AbstractResult<Serializable> handleError(BindingResult result) {
        ...
        log.warn(OutForUtil.buildWarnMessage(SystemResultEnum.BAD_REQUEST_PARAM_BIND_ERROR, message));
    ...
    public AbstractResult<Serializable> handleError(ConstraintViolationException e) {
        ...
        log.warn(OutForUtil.buildWarnMessage(SystemResultEnum.BAD_REQUEST_PARAM_VALID_ERROR, message));
    ...
    public AbstractResult<Serializable> handleError(NoHandlerFoundException e) {
        log.warn(OutForUtil.buildWarnMessage(SystemResultEnum.NOT_FOUND), e);
    ...
    public AbstractResult<Serializable> handleError(HttpMessageNotReadableException e) {
        log.warn(OutForUtil.buildWarnMessage(SystemResultEnum.BAD_REQUEST_MSG_NOT_READABLE, e.getMessage()));
    ...
    public AbstractResult<Serializable> handleError(HttpMediaTypeNotSupportedException e) {
        log.warn(OutForUtil.buildWarnMessage(SystemResultEnum.MEDIA_TYPE_NOT_SUPPORTED, e.getMessage()));
    ...
    public AbstractResult<Serializable> handleError(BusinessException e) {
        log.warn(OutForUtil.buildWarnMessage(e.getCode(), e.getMessage()), e);
    ...
    public AbstractResult<Serializable> handleError(SecureException e) {
        log.warn(OutForUtil.buildWarnMessage(e.getCode(), e.getMessage()));
